...
<div class="container mt-4">
    <div class="card">
        <div class="card-header bg-success text-white d-flex justify-content-between align-items-center">
            ...
            <a href="{{ route('profile.create') }}" class="btn btn-light">+ Nuevo Usuario</a>
        </div>
        <div class="card-body">
            @if(session('success'))
            ...
            <table class="table table-bordered table-striped">
                <thead>
                    <tr><th>ID</th><th>Usuario</th><th>Nombre</th><th>Email</th><th>Rol</th><th>Estado</th><th>Acciones</th></tr>
                </thead>
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('profile.edit', $u->id) }}" class="btn btn-sm btn-warning">Editar</a>
                            @if($u->id != auth()->id())
